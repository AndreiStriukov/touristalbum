...
class AddPhotoForm(forms.ModelForm):
    ...
    class Meta:
        model = Photo
        fields = ['ph_file', 'ph_name', 'ph_slug', 'ph_descr', 'ph_album']
...
class AddAlbum(forms.ModelForm):
    ...
    class Meta:
        model = JourneyAlbum
        fields = ['a_name', 'a_slug', 'a_descr', 'j_month', 'j_year', 'j_place', 'travel_participants', 'j_type']
...
class EditAlbum(forms.ModelForm):
    ...
    class Meta:
        model = JourneyAlbum
        fields = ['a_is_active', 'a_name', 'a_slug', 'a_descr', 'j_month', 'j_year', 'j_place', 'travel_participants', 'j_type']
...
class EditPhoto(forms.ModelForm):
    ...
    class Meta:
        model = Photo
        fields = ['ph_is_active', 'ph_file', 'ph_name', 'ph_slug', 'ph_descr', 'ph_album']
